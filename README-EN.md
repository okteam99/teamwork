...
[中文](./README.md) · Version: **v8.325** (version source of truth = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter)
...
Currently **v8.325** (version source of truth = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter). Changelog in [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md) (latest 5 versions) · older history via git log (CHANGELOG-ARCHIVE is **periodically wiped**).
