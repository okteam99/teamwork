...
>
> `last-synced: 2026-04-14` · 对齐 SKILL.md / ROLES.md / RULES.md / standards/common.md
...
├── docs/features/F{编号}-{功能名}/UI.md     ← 已验收的 UI 设计稿（Step 5.7 设计-代码一致性核对用）
├── docs/features/F{编号}-{功能名}/preview/ ← HTML 原型目录（如有）
