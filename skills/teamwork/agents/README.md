...
roles/           ← 角色定义（4 段：角色定位 / 评审职责 / 职能职责 / Stage 速查 + 协同）
├── pmo.md                     PMO 角色规范（瘦身中 · Wave 4 ongoing）
├── pmo-pm-acceptance-ship.md  PMO PM 验收 + Ship Stage 详规范（v7.3.10+P0-93 抽出）
├── pmo-external-orchestration.md PMO 外部模型评审调度详规范（v7.3.10+P0-93 抽出）
├── pmo-auto-mode.md           PMO 自动推进规则 + auto 模式（HITL/AFK）详规范（v7.3.10+P0-94 抽出）
├── pmo-cross-project.md       PMO 跨项目协调详规范（依赖识别 + 拆分 + 变更归属 · v7.3.10+P0-95 抽出）
├── pmo-state-mgmt.md          PMO 状态机维护详规范（路径路由 + state.json + 升级评估 · v7.3.10+P0-96 抽出）
├── pmo-reporting.md           PMO 报告 + 操作产物详规范（状态报告 + Test 前置 + 知识库 + review-log · v7.3.10+P0-97 抽出）
├── pm.md                      PM 角色 · 4 段重构 v7.3.10+P0-91
├── pm-prd-review.md           PRD 多角色评审详规范（v7.3.10+P0-91 抽出）
├── qa.md                      QA 角色 · 4 段重构 v7.3.10+P0-89
├── qa-cr.md                   QA Code Review 详规范（v7.3.10+P0-87 抽出）
├── qa-tc-review.md            TC 技术评审详规范（v7.3.10+P0-88 抽出）
├── rd.md                      RD 角色 · 4 段重构 v7.3.10+P0-90
├── architect.md               架构师角色（v7.3.10+P0-86 独立 peer-level role）
├── architect-cr.md            架构师 Code Review 详规范（v7.3.10+P0-87 抽出）
├── architect-tech-review.md   架构师 Tech Review 详规范（v7.3.10+P0-90 抽出）
├── designer.md                Designer 角色 · 4 段重构 v7.3.10+P0-92
├── product-lead.md            Product Lead 角色 · 4 段重构 v7.3.10+P0-92
├── product-lead-change-mgmt.md PL 变更管理详规范（v7.3.10+P0-92 抽出）
└── external-reviewer.md       External Reviewer 角色 · 4 段重构 v7.3.10+P0-92
```
