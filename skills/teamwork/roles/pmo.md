...
>
> 🔗 **相关单源**：[stages/init-stage.md § Step 0](../stages/init-stage.md)（AUTO_MODE 入口）+ [rules/flow-transitions.md § ⏸️ HITL 清单 / AFK 示例](../rules/flow-transitions.md)（HITL/AFK 单源）+ [STATUS-LINE.md § 决策点参考文档绝对路径硬规则](../STATUS-LINE.md)。
>
