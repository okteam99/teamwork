...
- 流程类型识别:闭集 Feature/Bug + preset(full/micro · v8.220-223)+ 不进状态机的 Feature Planning / 问题排查· 由 [SKILL.md § Triage 入口规范](../SKILL.md) 入口分诊 + [docs/prepare.md](../docs/prepare.md) 子流程承接(PMO 主对话执行)
