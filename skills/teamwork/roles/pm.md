...
- 处理 review finding:🔴 默认姿态=**质疑**(不盲目认同)· **ADOPT 前**先质疑 finding 不成立的最强反方(过度设计/错层/false positive)→ 回读代码确认它真成立才采纳(举证责任与 REJECT 对称 ·「reviewer 说得对」不是采纳理由 · 详 standards/external-model-usage.md §二)
