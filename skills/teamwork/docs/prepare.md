...
> 🔴 v8.220:流程类型机器层 = Feature/Bug + `--preset full|micro`(v8.223:lite 退役 · 敏捷需求→full〔轻量走 roster/clarity〕· Micro→micro)· 关键词命中「敏捷/micro」= 推荐对应 preset 而非独立类型。

## 1.4 模型档位与并行度(一行建议 · v8.225)
