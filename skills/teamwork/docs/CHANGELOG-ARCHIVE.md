# Changelog Archive(v8.77 → v1)

> 📦 **历史归档**:本文件保存 teamwork **v8.77 及更早**的全部 changelog(含 v7/v6/…/v1 等 v8.0 之前的旧系统)· 仅供追溯,**不再维护**。
> 现行 changelog(最近 1 版 · v8.78)见 [CHANGELOG.md](./CHANGELOG.md)。
