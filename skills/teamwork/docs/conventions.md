...
- **配置位置**:项目级 `.teamwork_localconfig.md` 中的 `worktree_root_path` 字段

## 10. worktree_root_path 配置

```yaml
# .teamwork_localconfig.md
...
- [templates/config.md](../templates/config.md) — `.teamwork_localconfig.md` 模板(worktree 字段)
