...
> 📎 **红线层级化**（v7.3.10+P0-103 / +P0-127）：本段是 **L1 核心红线**（必读 · ≤8 条）· 详细 schema / 反例 / 出口校验落 **L2 专项规范**（standards/* + roles/* sub-file）· 物理拦截机制（黑名单 / tools/state.py / tools/init_triage.py / templates/verify-ac.py）落 **L3 工具层**。
