...
命令 schema 见 docs/archive/v8-redesign/01-COMMAND-SCHEMA.md。
"""
...
def _render_pause_discipline(authorized_pause_point: str) -> str:
    ...
    伪暂停 · 把改动大/破坏式/不可逆/用户参与设计当暂停理由 · 实为 R4 违规):
      ...
      - **无暂停 stage 额外抬头**:dev/blueprint/blueprint_lite/test = 连续执行 ·
        任何暂停都违规。
    详细 rationale + 反模式黑名单见 docs/archive/v8-redesign/04-PAUSE-POINT-DISCIPLINE.md
...
- 📖 详细:[docs/archive/v8-redesign/04-PAUSE-POINT-DISCIPLINE.md](../docs/archive/v8-redesign/04-PAUSE-POINT-DISCIPLINE.md)
"""
    return head
