...
| 2 | WEB-F001-登录页面 | QA 代码审查 | QA | 无 | 2025-03-20 15:00 |
| 3 | AUTH-F002-权限管理 | ⏳ 等待外部依赖 | - | DEP-001@WEB | 2025-03-19 10:00 |

💡 建议优先推进 AUTH-F001（用户登录）
📝 理由：进度最靠前（RD 阶段），无阻塞，推进收益最大。AUTH-F002 等待外部依赖暂时无法推进。
