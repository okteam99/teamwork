...
- 出口走 `tools/state.py satisfy-gate --stage test --gate output --auto-commit $HASH [--artifacts a,b]` + `complete-stage --stage test`（v7.3.10+P0-128 物化 · 物理拦截 gate 顺序 / 三 gate 全满足 / artifact_root 写边界）
