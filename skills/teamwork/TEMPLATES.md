...
| 缩写 | 名称 | 类型 | 简介 | 承接执行线 | 技术栈 | 需要 UI | E2E | 消费方 | 项目详情 |
|------|------|------|------|-----------|--------|---------|-----|--------|----------|
| AUTH | 认证服务 | business | [简介] | Line 1 | | 否 | 否 | - | [链接] |
| WEB | 前端应用 | business | [简介] | Line 1, Line 2 | | 是 | 是 | - | [链接] |
| PAY | 支付中台 | midplatform | [简介] | Line 1 | | 否 | 否 | AUTH, WEB | [链接] |
| INFRA | 基础设施 | midplatform | [简介] | - | | 否 | 否 | 全部子项目 | [链接] |
