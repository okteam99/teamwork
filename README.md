...
[English](./README-EN.md) · Version: **v8.126**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）
...
完整红线条文见 [SKILL.md](./skills/teamwork/SKILL.md)（现行权威）· 设计 rationale 见 [docs/archive/v8-redesign/00-MANIFESTO.md](./skills/teamwork/docs/archive/v8-redesign/00-MANIFESTO.md)（v8.0 重构期归档）。
...
| [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md) | 最近 1 版变更（历史见 CHANGELOG-ARCHIVE.md） |
...
当前 **v8.126**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）。变更记录见 [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md)（最近 5 版）· 历史见 [docs/CHANGELOG-ARCHIVE.md](./skills/teamwork/docs/CHANGELOG-ARCHIVE.md)。
