...
[English](./README-EN.md) · Version: **v8.87**（v8.0 范式重构后持续演进）
...
当前 **v8.87**（v8.0 范式重构后持续演进）。变更记录见 [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md)（最近 1 版）· 历史见 [docs/CHANGELOG-ARCHIVE.md](./skills/teamwork/docs/CHANGELOG-ARCHIVE.md)。
