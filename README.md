...
[English](./README-EN.md) · Version: **v8.324**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）
...
当前 **v8.324**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）。变更记录见 [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md)（最近 5 版）· 更早历史走 git 提交历史（CHANGELOG-ARCHIVE **定期清空**）。
