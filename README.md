...
[English](./README-EN.md) · Version: **v8.123**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）
...
当前 **v8.123**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）。变更记录见 [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md)（最近 5 版）· 历史见 [docs/CHANGELOG-ARCHIVE.md](./skills/teamwork/docs/CHANGELOG-ARCHIVE.md)。
