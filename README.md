...
[English](./README-EN.md) · Version: **v8.229**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）
...
session 启动时 `bootstrap.py` 做系统维护(骨架 / hooks / localconfig 自愈)。🔴 v8.211 起**不再注入**宿主指令文件(CLAUDE.md / AGENTS.md / GEMINI.md)—— 共享仓库里注入块会污染不用 teamwork 的用户;关键信息(PMO 定位 / worktree 纪律 / Subagent 授权)以 SKILL.md 为唯一载体 · bootstrap 自动清理历史注入块。
...
当前 **v8.229**（版本单源 = [SKILL.md](./skills/teamwork/SKILL.md) frontmatter）。变更记录见 [docs/CHANGELOG.md](./skills/teamwork/docs/CHANGELOG.md)（最近 5 版）· 更早历史走 git 提交历史（CHANGELOG-ARCHIVE **定期清空**）。
